...
class SignUpIn(BaseModel):
    ...
    def validate_ruc(cls, v):
        ...
        # Validar formato de RUC paraguayo: 6 a 8 dígitos seguidos de un guión y un dígito verificador
        if not re.match(r'^\d{6,8}-\d$', v):
            raise ValueError("El RUC debe tener el formato: 123456-9, 1234567-8 o 12345678-9 (6 a 8 dígitos, guión, 1 dígito verificador)")
        return v
